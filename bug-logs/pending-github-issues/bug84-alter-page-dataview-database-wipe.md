...
**Source:** `bug-logs/mxcli-bugs.md`, `## BUG-84: ALTER PAGE ... SET DataSource = DATABASE
...
**Title:** `ALTER PAGE { SET DataSource = DATABASE Module.Entity ON <dataview>; }` reports success
but silently wipes the DataView's datasource entirely — `CE7007` downstream
