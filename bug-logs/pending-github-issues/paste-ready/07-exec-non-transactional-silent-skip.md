`mxcli exec` stops at the first failing statement and silently leaves every later statement unapplied — no summary, exit status does not say how much of the script landed
