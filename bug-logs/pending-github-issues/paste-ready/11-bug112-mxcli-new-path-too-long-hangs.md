`mxcli new` warns that the project path exceeds the 259-character MxToolset limit, then hangs forever in "Step 6/7: Running the first build" instead of failing
