...
# Two things this must get right, both found in the field on 2026-09-11 (Linux, a two-tree
# field project whose root .mpr is a SYMLINK into app/):
...
#      and the guard compares the catalog against "<app>.mpr 0 255 ef53 ... 2026-09-09T16:50:23".
